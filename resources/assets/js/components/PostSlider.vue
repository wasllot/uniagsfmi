	              ...
	              <div class="card border-0 rounded-0 text-white overflow zoom">
	                  <div class="position-relative">
	                      ...
	                      <div class="ratio_right-cover-2 image-wrapper">
                      			<router-link :to="`${grid[0].category.slug}/${grid[0].slug}`">
	                      ...
	                      <div class="position-absolute p-2 p-lg-3 b-0 w-100 bg-shadow">
	                          ...
	                          <router-link class="p-1 badge badge-primary rounded-0" :to="`${grid[0].category.slug}/${grid[0].slug}`">
	          ...
	          <div class="col-md-6 col-12  pb-1 pl-1 pt-0">
	             	<div class="card border-0 rounded-0 text-white overflow zoom">
	                  <div class="position-relative">
	                      <!--thumbnail img-->
	                      <div class="ratio_right-cover-2 image-wrapper">
                      			<router-link :to="`${grid[1].category.slug}/${grid[1].slug}`">
	                      ...
	                      <div class="position-absolute p-2 p-lg-3 b-0 w-100 bg-shadow">
	                          ...
	                          <router-link class="p-1 badge badge-primary rounded-0" :to="`${grid[1].category.slug}/${grid[1].slug}`">
	          ...
	          <div class="col-md-6 col-12  pb-1 pr-1 pt-1">
	              <div class="card border-0 rounded-0 text-white overflow zoom">
	                  <div class="position-relative">
	                      <!--thumbnail img-->
	                      <div class="ratio_right-cover-2 image-wrapper">
                      			<router-link :to="`${grid[2].category.slug}/${grid[2].slug}`">
	                      ...
	                      <div class="position-absolute p-2 p-lg-3 b-0 w-100 bg-shadow">
	                          ...
	                          <router-link class="p-1 badge badge-primary rounded-0" :to="`${grid[2].category.slug}/${grid[2].slug}`">
	          ...
	          <div class="col-md-6 col-12  pb-1 pl-1 pt-1">
	              <div class="card border-0 rounded-0 text-white overflow zoom">
	                  <div class="position-relative">
	                      <!--thumbnail img-->
	                      <div class="ratio_right-cover-2 image-wrapper">
                      			<router-link :to="`${grid[3].category.slug}/${grid[3].slug}`">
	                      ...
	                      <div class="position-absolute p-2 p-lg-3 b-0 w-100 bg-shadow">
	                          ...
	                          <router-link class="p-1 badge badge-primary rounded-0" :to="`${grid[3].category.slug}/${grid[3].slug}`">
