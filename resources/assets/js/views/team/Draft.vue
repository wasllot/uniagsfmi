    ...
    <div>
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0">{{ trans('post.teams') }}</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <router-link to="/home">{{ trans('general.home') }}</router-link>
                    </li>
                    <li class="breadcrumb-item">
                        <router-link to="/post">{{ trans('post.teams') }}</router-link>
                    </li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <team-sidebar menu="draft" :statistics="statistics"></team-sidebar>
                            <div class="col-10 col-lg-10 col-md-10">
                                ...
                                <h6 class="card-subtitle" v-if="teams">
                                    {{ trans('general.total_result_found',{'count': teams.total}) }}
                                </h6>
                                ...
                                <pagination-record :page-length.sync="filterPostForm.page_length" :records="teams"
